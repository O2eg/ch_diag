select
	...
	floor(max(CurrentMetric_BackgroundMergesAndMutationsPoolTask), 2) as MergesAndMutationsPoolTask,
	floor(max(CurrentMetric_BackgroundFetchesPoolTask), 2) as FetchesPoolTask,
	floor(max(CurrentMetric_BackgroundCommonPoolTask), 2) as CommonPoolTask,
