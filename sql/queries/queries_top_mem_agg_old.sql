-- queries_top_mem_agg_old - subquery to avoid "Cannot find column _shard_num in source stream" before 20.4
-- queries_top_mem_agg_20_4 - without subquery
-- queries_top_mem_agg_20_7 - added "current_database"
-- queries_top_mem_agg_21_1 - added "normalized_query_hash"
select
	_shard_num,
	host_name,
